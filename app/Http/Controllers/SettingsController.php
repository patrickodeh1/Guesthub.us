...
class SettingsController extends Controller
{
    ...
    public function update(SettingsUpdateRequest $request)
    {
        ...
        Setting::set('notify_cleaning_started_global', $request->boolean('notify_cleaning_started_global') ? '1' : '0');
        Setting::set('notify_cleaning_finished_global', $request->boolean('notify_cleaning_finished_global') ? '1' : '0');
        Setting::set('notify_photo_started_global', $request->boolean('notify_photo_started_global') ? '1' : '0');
        Setting::set('notify_task_notes_global', $request->boolean('notify_task_notes_global') ? '1' : '0');

        // Training enforcement settings
        Setting::set('mandatory_instruction_viewing', $request->boolean('mandatory_instruction_viewing') ? '1' : '0');
        if ($request->filled('global_required_instruction_views')) {
            Setting::set('global_required_instruction_views', max(1, min(100, (int) $request->global_required_instruction_views)));
        }
