<x-admin-layout title="Guest Guide">
    <div class="page-header">
        <div>
            <p class="eyebrow">Guest experience</p>
            <h1 class="page-title">Guest Guide</h1>
            <p class="page-subtitle">Choose a property to manage its categories (WiFi, amenities, restaurants, and more).</p>
        </div>
    </div>
            ...
            <article class="card overflow-hidden">
                ...
                <div class="card-pad">
                    ...
                    <div class="mt-5 flex flex-wrap gap-2">
                        <a href="{{ route('admin.guest-guide.show', $property) }}" class="btn-secondary">Manage Categories</a>
                    </div>
                </div>
            </article>
        @empty
