...
export default function propertyTaskForm({ suggestUrl, storeUrl, csrf, propertyId, roomId, taskId, mode, panelName, initialData }) {
    return {
        ...
        formData: {
            ...
            is_pre_arrival: initialData.is_pre_arrival || false,
            is_required_before_start: initialData.is_required_before_start || false,
            is_required_during_task: initialData.is_required_during_task || false,
        ...
        async submitForm(event) {
            ...
            try {
                ...
                formData.set('is_pre_arrival', this.formData.is_pre_arrival ? '1' : '0');
                formData.set('is_required_before_start', this.formData.is_required_before_start ? '1' : '0');
                formData.set('is_required_during_task', this.formData.is_required_during_task ? '1' : '0');
