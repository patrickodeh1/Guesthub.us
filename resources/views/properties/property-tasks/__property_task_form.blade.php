    ...
    <form @submit.prevent="submitForm" enctype="multipart/form-data" class="space-y-6 flex flex-col">
        @if($isEdit)
            ...
            <div class="flex items-center gap-3 p-3 sm:p-4 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700">
                ...
                <div>
                    <p class="text-[11px] font-semibold uppercase tracking-wider text-gray-500 dark:text-gray-400 mb-0.5">Context</p>
                    <p class="text-sm font-medium text-gray-900 dark:text-gray-100">Property Level Task</p>
                </div>
            </div>
        @endif
