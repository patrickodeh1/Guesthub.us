                    ...
                    <div class="md:col-span-2 pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                        <div class="bg-blue-50 border-l-4 border-blue-400 p-4 dark:bg-blue-900/30 dark:border-blue-500">
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <h3 class="text-sm font-medium text-blue-800 dark:text-blue-300">Initial Password</h3>
                                    <div class="mt-2 text-sm text-blue-700 dark:text-blue-400">
                                        <p>The initial password for this user will automatically be set to <strong>password</strong>. They will be forced to change it on their first login.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
